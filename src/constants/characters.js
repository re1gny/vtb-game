...
export const CHARACTERS = [
  ...
  },
  {
    ...
    description:
      'Ваш персонаж всегда переполнен идеями. Для него важна возможность участвовать в реализации важных и интересных проектов, а ещё реализовывать свои и получать поддержку от коллег и наставников.',
  ...
  },
  {
    ...
    description:
      'Для вашего персонажа важна стабильность в работе и уверенность своём работодателе. Он очень трудолюбив, ценит творческий подход. Для персонажа важна поддержка коллег и наставников.',
