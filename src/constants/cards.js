...
export const TASK_CARDS = [
  ...
  },
  {
    ...
    type: 'list',
    items: [
      'Полная расшифровка ВТБ?',
      'Термин, обозначающий прямой товарообмен?',
      'Назовите героя сказок, который «чах над златом»',
    ],
    columns: 1,
    ...
    timer: 45,
    answer: '\n1. Внешторгбанк/Банк внешней торговли \n2. Бартер \n3. Кощей',
  },
  {
    id: 69,
    number: 70,
  ...
  },
  {
    ...
    items: [
      ...
      'Как называется процесс обесценивания денег?',
