...
export const TASK_CARDS = [
  ...
  },
  {
    id: 22,
    number: 23,
    description: 'Задание зачитывает ведущий.',
  },
  {
    id: 23,
    number: 24,
  ...
  },
  {
    ...
    subDescription: 'Проведите зарядку для своей команды в течение 20 секунд и перейдите на ближайшую клетку Шанс',
    timer: 20,
  },
  {
    id: 47,
  ...
  },
  {
    ...
    type: 'list',
    items: [
      'а) Полная расшифровка ВТБ?',
      'б) Термин, обозначающий прямой товарообмен?',
      'в) Назовите героя сказок, который «чах над златом»',
    ],
    columns: 1,
    ...
    timer: 45,
    answer: '\nа) Внешторгбанк/Банк внешней торговли \nб) Бартер \nв) Кощей',
  },
  {
    id: 69,
    number: 70,
  ...
  },
  {
    ...
    type: 'list',
    items: [
      'а) Какая валюта используется в Швейцарии?',
      'б) Как называется процесс обесценивания денег?',
      'в) Можно ли оформить карточку в банке за другого человека?',
    ],
    columns: 1,
    title: 'Повышение квалификации',
    description:
