...
export const TASK_CARDS = [
  ...
  },
  {
    ...
    answers: [
      ...
      { text: 'Кавказскую лесную кошку', sign: AnswerSign3, correct: false },
      { text: 'Каспийских тюленей', sign: AnswerSign4, correct: false },
    ],
    title: 'Навык: Благотворительность',
  ...
  },
  {
    ...
    description: 'Назовите 3 важных качества для менеджера.',
    subDescription: 'За каждый верный ответ вы продвигаетесь вперед на 4 шага.',
    timer: 20,
  },
  {
    id: 12,
  ...
  },
  {
    ...
    subDescription: 'Если выполнили задание, идите вперед на 6 шага.',
    timer: 60,
  },
  {
    id: 19,
    number: 20,
    description: 'Отгадайте должность.',
  ...
  },
  {
    ...
    number: 25,
    type: 'list',
    items: ['Презентация', 'Сделка', 'Возражение', 'Продажа', 'Контакт'],
    columns: 2,
    title: 'Навык: Напарник мечты',
    description:
      'Выберите одного из игроков чужой команды и объясните ему 5 слов, не используя однокоренные. Можно объяснять слова не по порядку.',
  ...
  },
  {
    ...
    number: 26,
    type: 'list',
    items: ['Банкомат', 'Криптовалюта', 'Кэшбек', 'Клиент', 'Мобильный банк'],
    columns: 2,
    title: 'Навык: Напарник мечты',
    description:
      'Выберите одного из игроков чужой команды и объясните ему 5 слов, не используя однокоренные. Можно объяснять слова не по порядку.',
  ...
  },
  {
    ...
    number: 27,
    type: 'list',
    items: ['Премия', 'Горящие сердца', 'Отчёт', 'Рабочее место', 'Коллега'],
    columns: 2,
    title: 'Навык: Напарник мечты',
    description:
      'Выберите одного из игроков чужой команды и объясните ему 5 слов, не используя однокоренные. Можно объяснять слова не по порядку.',
  ...
  },
  {
    ...
    number: 28,
    type: 'list',
    items: ['Дивиденды', 'Процент', 'Сбережения', 'Касса'],
    columns: 2,
    description:
  ...
  },
  {
    ...
    number: 29,
    type: 'list',
    items: ['Инвестиции', 'Доход', 'Договор', 'Вклад'],
    columns: 2,
    description:
      'Объясни слова своей команде без использования однокоренных слов. Можно объяснять слова не по порядку.',
    subDescription: 'За каждое отгаданное слово команда продвигается на 1 шаг.',
  ...
  },
  {
    ...
    number: 30,
    type: 'list',
    items: ['Инвестор', 'Портфель', 'Акции', 'Ипотека'],
    columns: 2,
    description:
      'Объясни слова своей команде без использования однокоренных слов. Можно объяснять слова не по порядку.',
    subDescription: 'За каждое отгаданное слово команда продвигается на 1 шаг.',
  ...
  },
  {
    ...
    number: 31,
    description:
      'Наставник заболел и отправил вам задачу, однако произошла ошибка и письмо дошло не полностью, команде нужно его разгадать. Наставник команды рисует сообщение, а команда должна разгадать шифр.',
    subDescription: 'Если выполнили задание, идите вперед на 5 шагов.',
    timer: 60,
  ...
  },
  {
    id: 46,
    number: 47,
    title: 'Навык: Офисный спортсмен',
    description: 'Сегодня в офисе день спорта!',
    subDescription: 'Проведите зарядку для своей команды в течение 20 секунд и возьмите карточку Шанс',
    timer: 20,
  },
  {
    id: 47,
  ...
  },
  {
    id: 49,
    number: 50,
    description: 'Задайте вопрос на тему финансов команде слева от вас.',
    subDescription:
      'Если она отвечает неверно, ваша команда продвигается на 4 шага вперед. \nЕсли верно — обе команды продвигаются на 4 шага вперед. \n\nПредоставьте доказательство верного ответа в течение 15 секунд.',
    timer: 60,
  },
  {
    id: 50,
  ...
  },
  {
    ...
    subDescription: 'Если выполнили задание, возьмите карточку «Шанс» и идите на 5 шагов вперед.',
    timer: 20,
    answer: 'Надежность',
  },
  {
  ...
  },
  {
    ...
    number: 65,
    description:
      'Ваша команда хочет купить онлайн-курс по развитию навыков в продажах.\nВыберите любую команду, которой необходимо найти загаданное решение.\nОна должна задавать вопросы, на которые вы можете ответить да/нет. Ответом будет являться продукт или услуга Банка ВТБ.',
    subDescription: 'Если выполнили задание, вы и команда, угадавшая фразу, идете вперед на 6 шагов.',
    timer: 60,
  ...
  },
  {
    ...
    number: 71,
    description:
      'Успей записаться на стажировку и сдай вовремя все необходимые документы. Ведущий зачитает список документов, команде нужно запомнить все и пересказать',
    subDescription: 'Если выполнили задание: идите вперед на 5 шагов',
    timer: 20,
  },
  {
  ...
  },
  {
    ...
    timer: 60,
    answer: 'Именные гранты',
    answerLink: 'https://vk.com/vtb_career?w=wall-214504417_181',
  },
  {
    id: 78,
    number: 79,
  ...
  },
  {
    ...
    number: 83,
    description:
      'Найди на карьерном сайте ВТБ  информацию о стандартных этапах отбора в команду ВТБ.\n Назови этапы отбора',
    subDescription: 'Если выполнили задание: идите вперед на 6 шагов.',
    timer: 60,
    answer:
  ...
  },
  {
    id: 84,
    number: 85,
    description: 'Найди на сайте почтовый адрес ВТБ и озвучь его',
    subDescription: 'Если выполнили задание: идите вперед на 5 шагов',
    timer: 60,
    answer: 'Банк ВТБ (ПАО), г. Москва, 109147, ул. Воронцовская, д. 43, стр. 1.',
